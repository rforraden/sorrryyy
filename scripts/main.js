;(function (window) {
    ...
    let texts = ['Tap anywhere :)','OH AND USE LANDSCAPE MODE', 'DONE???', 'HEY ZURAA', 'MY BABYY', 'MY SWEETHEARTT', 'MY LOVEE', 'my everything..', 'made this for you', 'kaka gajelas ya', 'ahhhh i just', 'wanna say that im sorry', ';(', 'I didnt send her that pic', 'i know i seems panic or idk kemarin', 'fuck im sorry', 'i swear', 'u already hear it from her..', 'im sorry', 'are u still mad?', ';(', 'I', 'love', 'you ', 'please trust me', 'im sorry zura', 'kiss', 'open the next linkk']
